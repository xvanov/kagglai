...
|----------|--------|--------------|
| problem-statement.md | {yes/no} | {date} |
...
**Cascade Effects:**
- Editing **problem-statement** may affect: EDA recommendations, SoTA applicability, all downstream docs
...
- If you edit early documents (problem-statement, EDA), consider whether downstream documents need updates
...
1. **Project details changed** → Edit problem-statement
