...
- ✅ Assess whether recommendations fit this specific project
...
- 📖 Verify recommendations match project constraints
...
I am a fresh Researcher instance reviewing the state of the art synthesis. I will verify sources, check for unsupported claims, and assess applicability to this project.
...
- **Similar Project Insights:** {what worked before}
...
- Not checking against project constraints
