---
name: 'step-02-problem-statement'
description: 'Data Analyst authors the problem statementification from input documents'

nextStepFile: './step-03-problem-statement-review.md'
...
# Step 2: Author Problem Statementification

## STEP GOAL:

To systematically extract and synthesize all project requirements from input documents into a comprehensive, structured problem statementification that serves as the single source of truth for the entire project.
...
- 💾 Create problem-statement.md using the template structure
...
"**Step 02: Problem Statementification Authoring**

I will now systematically extract all project requirements from your input documents and synthesize them into a structured problem statementification.
...
1. {descriptionFile} - Project overview and problem statement
...
- If information might be in project forums: Note as "[CHECK FORUMS: ...]"
...
### 7. Write Problem Statementification
...
Update {sidecarFile}:
- Add 'step-02-problem-statement' to stepsCompleted
- Set lastStep to 'step-02-problem-statement'
...
"**Problem Statementification Complete**
...
**[C]ontinue** to problem statement validation"
...
- Leaving template placeholders (like `{project_name}`)
