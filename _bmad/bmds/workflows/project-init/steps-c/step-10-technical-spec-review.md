...
- 💾 Verify against problem-statement constraints
...
|------------|-------|-------------|----------|
| Runtime | {from problem-statement} | {from tech-spec} | {yes/no/uncertain} |
| Memory | {from problem-statement} | {from tech-spec} | {yes/no/uncertain} |
| GPU | {from problem-statement} | {from tech-spec} | {yes/no/uncertain} |
| External data | {from problem-statement} | {from tech-spec} | {yes/no/uncertain} |
| Pre-trained models | {from problem-statement} | {from tech-spec} | {yes/no/uncertain} |
