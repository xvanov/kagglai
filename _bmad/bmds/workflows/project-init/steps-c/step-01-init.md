...
nextStepFile: './step-02-problem-statement.md'
...
To initialize the data science project structure, verify required inputs exist, and create the sidecar file for workflow state tracking.
...
- ✅ You bring workflow expertise and standards, user brings project context
- ✅ Together we establish a solid foundation for the project
...
- User should have placed challenge documents in `problem-inputs/`
...
"**Welcome to the Data Science Project Setup Workflow!**

This workflow will guide you through setting up a rigorous foundation for your project:

1. **Problem Statementification** - Extract and validate all project requirements
...
```
{experiments_folder}/
├── problem-inputs/             # User provides these
...
Check for required files in `{experiments_folder}/problem-inputs/`:
...
- List what's missing
- Provide guidance: "Please create the missing files in `_bmds/problem-inputs/` with the relevant information from the project page."
...
**Next step:** Problem Statementification
- Agent: Data Analyst
- Task: Extract and synthesize challenge requirements into `problem-statement.md`

Proceeding to problem statementification..."

### 7. Auto-Proceed to Next Step

Display: "**Proceeding to Step 02: Problem Statementification...**"
