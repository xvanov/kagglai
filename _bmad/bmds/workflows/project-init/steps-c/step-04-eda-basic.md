...
- Data access instructions are in problem-inputs/
...
1. Verify/pull the project data
...
**File Verification:**
- [ ] All expected files present (from problem-statement)
...
- Identify target column (from problem-statement)
