...
- Loads and preprocesses project data
...
- [ ] Submission accepted by project platform
...
**Format:** {format from problem-statement}
...
|----------|---------------------|
| problem-statement.md | {what was referenced} |
