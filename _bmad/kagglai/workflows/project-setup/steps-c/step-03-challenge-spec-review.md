---
name: 'step-03-challenge-spec-review'
description: 'Fresh Data Analyst validates challenge spec and implements fixes'

nextStepFile: './step-04-eda-basic.md'
fixOnlyFile: './step-03b-challenge-spec-fix.md'
sidecarFile: '{experiments_folder}/docs/.project-setup-sidecar.md'
experimentsFolder: '{experiments_folder}'
specFile: '{experiments_folder}/docs/challenge-spec.md'
...
# Step 3: Challenge Specification Review

## STEP GOAL:

To validate the challenge specification against source documents and quality criteria, identify issues, implement fixes, and initialize Section 1 of current-understanding.md. This step uses the Author/Validator pattern - you are a FRESH instance reviewing another's work.
...
- 🎯 Read challenge-spec.md with skeptical eye
...
- The challenge-spec.md was authored by a previous instance
...
"**Step 03: Challenge Specification Review**

I am a fresh Data Analyst instance reviewing the challenge specification. I will validate every claim against source documents and identify any issues.

Beginning systematic review..."

### 2. Load Review Standards

Read {reviewCriteriaFile} for the "Challenge Specification Review" section.
Read {validationChecklistFile} for the "Challenge Specification Validation" checklist.

### 3. Read the Challenge Spec
...
Work through each item in the Challenge Specification Validation checklist:
...
```markdown
## Challenge Specification Review Report

**Document:** challenge-spec.md
...
Update {sidecarFile}:
- Add 'step-03-challenge-spec-review' to stepsCompleted
- Set lastStep to 'step-03-challenge-spec-review'
...
"**Challenge Specification Review Complete**
...
**Documents updated:**
- challenge-spec.md {if fixes applied}
