...
To comprehensively survey the current state of the art for this problem domain through academic papers, competition write-ups, and web research, synthesizing findings into a structured document that informs research direction decisions.
...
- 🎯 Focus on WHAT WORKS and WHAT'S APPLICABLE to this competition
...
- 🎯 Read challenge spec and EDA report before researching
- 💾 Search web for recent techniques and competition solutions
...
### 4. Web Research - Similar Competitions

Search for similar past competitions:

**Search queries:**
- "{problem type} kaggle competition solution"
- "{evaluation metric} kaggle winning approach"
- "kaggle {domain} competition write-up"

**For each relevant competition found:**
- Note the competition name and year
- Identify winning approaches
- Extract key techniques used
- Assess relevance to this competition
...
**Section 6 - Competition-Specific:**
- Similar past competitions
- Lessons from their solutions
- What didn't work and why

**Section 7 - Applicability to This Competition:**
...
- All papers reviewed
- Competition write-ups consulted
...
- Similar competitions analyzed: {count}
